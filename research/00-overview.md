...
*Research date: 8 September 2026 (version 3). Version 1, dated 6 September, assumed a Nordic-based founder; the founder said the market is most likely the United States and the list must hold regardless of location, so version 2 rewrote all 50 ideas for a US-first buyer and replaced seven ideas that only existed because of EU or Nordic regulation. The founder then picked idea 9 (roof, fence and solar measurement) as an area of interest and asked for five more ideas in each of three new areas — sports, the short-term rental industry, and healthcare staffing. Version 3 adds those 15 ideas (51–65) as three new chapters and adds a stand-alone deep-dive chapter on idea 9. The original 50 ideas and their scores are unchanged. Versions 1 and 2 remain in the git history.*

## 1. What this research is for

You asked for deep research on a new SaaS product you could build yourself, with 50 ideas, each covering the problem, who has it, the value of solving it, competitors, pricing models, the path to profitability, where AI can be used to build it, and what it takes to reach an MVP. This document set answers that, and now covers 65 ideas: the original 50 plus 15 more across sports, the short-term rental industry and healthcare staffing, added after you picked idea 9 and asked for five ideas in each of those three areas. It is written for one person deciding what to build next, not for investors.

## 2. What we are doing and what we are not doing

**We are doing**

- Generating 65 distinct product ideas that one developer can plausibly build to a paying MVP in 4–16 weeks of focused work with AI coding assistance.
...
- **Eight ideas score 21 or more** and are shortlist-grade: 42, 1, 21, 23, 26, 27, 30, and (new in version 3) 61.
- **Forty score 18–20** and are viable with a specific condition named in each verdict: a platform's API terms, a partner channel, a lawyer, a trust gate, or a regulatory restart. The strongest of them: 13, 16, 18, 24, 28, 33 and 46 at 20, plus (new) 55, 56 and 59 at 20.
- **Seventeen score 17 or below** and are not worth a solo founder's year, for structural reasons: free or entrenched incumbents (2, 7, 12, 14, 15, 45, 50, 60), a platform that blocks, bundles or owns distribution (19, 36, 41, 49), a feature rather than a product (5, 22), a content and regulatory gate (44), or two well-funded consolidators already covering the workflow (the sports-cluster ideas 52 and 53). No idea in the three new clusters beat the existing top eight, which is why the recommendation in this section is unchanged from version 2.
